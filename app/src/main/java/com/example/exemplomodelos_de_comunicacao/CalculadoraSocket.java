...
public class CalculadoraSocket extends AsyncTask<Void, Void, String> {
    ...
    PrecisaCalcular pc;
    Integer operacao;
    public CalculadoraSocket(TextView tv, String oper1, String oper2, Integer operacao){
        this.tv=tv;
        this.oper1=oper1;
        this.oper2=oper2;
    ...
    public CalculadoraSocket(PrecisaCalcular pc, String oper1, String oper2, Integer operacao){
        this.tv=tv;
        this.oper1=oper1;
        this.oper2=oper2;
        this.pc=pc;
